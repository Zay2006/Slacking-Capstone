...
// Load Slack tokens from env
const SLACK_BOT_TOKEN = process.env.SLACK_BOT_TOKEN;
const SLACK_APP_TOKEN = process.env.SLACK_APP_TOKEN;
const SLACK_SIGNING_SECRET = process.env.SLACK_SIGNING_SECRET;

// Display tokens (safely)
console.log(`Bot Token (first chars): ${SLACK_BOT_TOKEN.substring(0, 10)}...`);
console.log(`App Token (first chars): ${SLACK_APP_TOKEN.substring(0, 10)}...`);
